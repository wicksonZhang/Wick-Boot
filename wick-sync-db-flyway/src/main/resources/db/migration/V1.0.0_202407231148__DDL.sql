...
(
    ...
    `is_pk`          tinyint                                                       NOT NULL DEFAULT 1 COMMENT '是否主键（1是）',
    `is_increment`   tinyint                                                       NOT NULL DEFAULT 1 COMMENT '是否自增（1是）',
    `is_required`    tinyint                                                       NOT NULL DEFAULT 1 COMMENT '是否必填（1是）',
    `is_insert`      tinyint                                                       NOT NULL DEFAULT 1 COMMENT '是否为插入字段（1是）',
    `is_edit`        tinyint                                                       NOT NULL DEFAULT 1 COMMENT '是否编辑字段（1是）',
    `is_list`        tinyint                                                       NOT NULL DEFAULT 1 COMMENT '是否列表字段（1是）',
    `is_query`       tinyint                                                       NOT NULL DEFAULT 1 COMMENT '是否查询字段（1是）',

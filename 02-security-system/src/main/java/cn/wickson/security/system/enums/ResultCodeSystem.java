...
public interface ResultCodeSystem {
    ...
    ResultCode AUTH_USER_NOT_FOUND = new ResultCode(1002000002, "当前用户不存在");
    ResultCode AUTH_USER_PASSWORD_ERROR = new ResultCode(1002000003, "当前用户账号密码错误");
    ResultCode AUTH_USER_STATUS_DISABLE = new ResultCode(1002000004, "当前账号已被停用");
